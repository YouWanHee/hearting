...
check_codex_tool_projection() {
  ...
  TOOL_DEFERRED="$TOOL_DEFERRED check-sd-procedure-hooks.py check_sd_procedure_hooks.test.py sd-procedure-hooks.tsv stage-advance-census.py stage_advance_census.test.py dispatch-refusal-census.py dispatch_refusal_census.test.py"
  tool_count=0
  for f in tools/*; do
    [ -e "$f" ] || continue
