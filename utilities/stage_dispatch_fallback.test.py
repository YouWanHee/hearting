...
class FallbackTest(unittest.TestCase):
 def setUp(self):
  ...
  # This fixture tests launch ordering, not the shipped main-only model policy.
  # Select one complete private user config with an eligible delegated deep model.
