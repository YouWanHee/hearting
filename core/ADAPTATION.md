...
- The interactive Claude `asyncRewake` bridge never reads the Bash command
  ...
  and dead-holder or lapsed records after thirty, a live holder never) makes
